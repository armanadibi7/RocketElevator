...
function radioAction(){
    if(document.getElementById('standard-radio').checked) {
        radioSelected = 7565;
        fee = 1.1;
        $('#txtPriceElevator').attr('placeholder',"7,565.00 $");
        
    
      }else if(document.getElementById('premium-radio').checked) {
         radioSelected=12345;
         fee = 1.13;
        $('#txtPriceElevator').attr('placeholder',"12,345.00 $");
    
      }else if(document.getElementById('excelium-radio').checked) {
        fee = 1.16;
        radioSelected= 15400;
